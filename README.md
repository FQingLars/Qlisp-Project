...
| [22. Tablet](book/22-tablet.md) | Детерминированный DataFrame-аналог pandas: groupby/merge/окна, CSV/JSON, NA-дисциплина | `pandas` |

## Быстрый старт

```bash
# Скачать бинарник (Linux x86_64, релиз v2.7.2)
